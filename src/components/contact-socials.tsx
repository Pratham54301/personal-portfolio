  ...
  },
  {
    ...
    icon: (
        <svg
            ...
            className="w-5 h-5"
        >
            <path d="M4.62 10.45c-.23.49-.38.99-.38 1.55 0 .61.12 1.2.36 1.76h5.3c-.22-.56-.34-1.16-.34-1.76 0-.6.12-1.18.34-1.76H4.62z"/>
            <path d="M14 6h-4v.91c.88.24 1.48.66 1.48 1.48v0c0 .82-.6 1.24-1.48 1.48V12h4v-.91c-.88-.24-1.48-.66-1.48-1.48v0c0 .82.6-1.24 1.48-1.48V6z"/>
